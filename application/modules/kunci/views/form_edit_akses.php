                        ...
                        <div class="panel-content">
                            <form id="inline-validation" method="POST" class="form-horizontal form-stripe form-submit" novalidate="novalidate" data-button="#btn-submit" action="<?php echo site_url('admin/edit');?>" data-redirect="<?php echo site_url('admin/admin');?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="admin_name" name="admin_name" value="<?php echo $row[0]->admin_name;?>" readonly="">
                                    </div>
                                </div>
                                <?php
                                $id = $row[0]->admin_id;
                                ...
                                ?>
                                <div class="form-group" style="margin-left:5%; margin-right:5%; border: 1px solid black; padding: 5px;">
                                    <div class="form-group">
