	...
	{	
		...
		if($query->num_rows() > 0){
			foreach ($query->result_array() as $key => $row) {
				...
				$row['edits'] = '<a href="'.site_url().'pmm/productions/sunting_komposisi/'.$row['id'].'" class="btn btn-warning" style="font-weight:bold; border-radius:5px;"><i class="fa fa-edit"></i> </a>';
				$edit = false;
				$edit = '<a href="javascript:void(0);" onclick="EditData('.$row['id'].')" class="btn btn-warning" style="font-weight:bold; border-radius:5px;"><i class="fa fa-edit"></i> </a>';	
				$edit_new = false;
				$edit_new = '<a href="javascript:void(0);" onclick="EditDataNew('.$row['id'].')" class="btn btn-primary" style="font-weight:bold; border-radius:5px;"><i class="fa fa-edit"></i> </a>';
