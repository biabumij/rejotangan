...
<?php if($kunci_rakor == 1){?>
    <div class="col-sm-5">
    <button style="background-color:#88b93c; border-radius:5px; line-height:30px;"><a href="<?php echo site_url('produksi/form_pemakaian'); ?>"><b style="color:white;">BUAT VERIFIKASI</b></a></button>
    </div>
<?php
}
?>
