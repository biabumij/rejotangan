                            ...
                            <form id="inline-validation" method="POST" class="form-horizontal form-stripe form-submit" novalidate="novalidate" data-button="#btn-submit" action="<?php echo site_url('menu/edit');?>" data-redirect="<?php echo site_url('admin/menu');?>">
                                ...
                                <div class="form-group text-center">
                                    <div>
                                        <br />
                                        <br />
                                        <a href="<?php echo site_url('admin/menu'); ?>" class="btn btn-default" style="width:10%; font-weight:bold; border-radius:5px; margin-top: 10px;"> KEMBALI</a>
                                        <button type="submit" name="submit" class="btn btn-danger" id="btn-submit" data-loading-text="please wait.." style="width:10%; font-weight:bold; border-radius:5px;">KIRIM</button>
                                        <br />
                                        <br />
                                        <br />
                                        <br />
