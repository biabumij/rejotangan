                        ...
                        <div class="panel-content">
                            <form id="inline-validation" method="POST" class="form-horizontal form-stripe form-submit" novalidate="novalidate" data-button="#btn-submit" action="<?php echo site_url('admin/edit');?>" data-redirect="<?php echo site_url('admin/admin');?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="name" class="col-sm-2 control-label">Hapus Tagihan Pembelian<span class="required" aria-required="true">*</span></label>
                                    <div class="col-sm-1">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label">Edit RAP, Rencana Kerja, Stock Opname, Pemakaian Bahan<span class="required" aria-required="true">*</span></label>
                                    <div class="col-sm-1">
