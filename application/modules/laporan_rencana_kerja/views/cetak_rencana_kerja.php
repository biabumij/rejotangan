	...
	<body>
		...
		<table width="99%" cellpadding="3" border="1">
			...
			<tr class="table-baris">
				...
				<th align="left">LPA (JLS Brantas) - Batu Split 0,5 - 10 mm (Upah Giling)</th>
			...
			<tr class="table-subtotal">
				...
				<th align="right"><?php echo number_format($sub_vol_akumulasi,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_akumulasi,0,',','.');?></th>
				<th align="right"><?php echo number_format($sub_vol_rak1,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_rak1,0,',','.');?></th>
				<th align="right"><?php echo number_format($sub_vol_rak2,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_rak2,0,',','.');?></th>
				<th align="right"><?php echo number_format($sub_vol_rak3,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_rak3,0,',','.');?></th>
				<th align="right"><?php echo number_format($sub_vol_rak4,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_rak4,0,',','.');?></th>
				<th align="right"><?php echo number_format($sub_vol_rak5,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_rak5,0,',','.');?></th>
				<th align="right"><?php echo number_format($sub_vol_rak6,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_rak6,0,',','.');?></th>
				<th align="right"><?php echo number_format($sub_vol_rak7,2,',','.');?></th>
				<th align="right"><?php echo number_format($sub_rak7,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_vol_sub,2,',','.');?></th>
