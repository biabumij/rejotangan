                        ...
                        <div class="panel">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="text-center">
                                    <a href="<?= site_url('pembelian/penagihan_pembelian_detail/'.$row['penagihan_pembelian_id']);?>" class="btn btn-info" style="width:10%; font-weight:bold; border-radius:5px;"> KEMBALI</a>
                                </div>
                            </div>
                        </div>
                    </div>
